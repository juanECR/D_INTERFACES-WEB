                    ...
                    <div class="table-responsive table-centered">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>24 April, 2024</td>
                                    <td><img src="src/view/assets/images/users/avatar-2.jpg" alt="avatar-2"
                                ...
                                <tr>
                                    <td>24 April, 2024</td>
                                    <td><img src="src/view/assets/images/users/avatar-3.jpg" alt="avatar-2"
                                            class="img-fluid avatar-xs rounded-circle"> <span
                                ...
                                <tr>
                                    <td>20 April, 2024</td>
                                    <td><img src="src/view/assets/images/users/avatar-4.jpg" alt="avatar-2"
                                            class="img-fluid avatar-xs rounded-circle"> <span
                                ...
                                <tr>
                                    <td>18 April, 2024</td>
                                    <td><img src="src/view/assets/images/users/avatar-5.jpg" alt="avatar-2"
                                            class="img-fluid avatar-xs rounded-circle"> <span
                                ...
                                <tr>
                                    <td>18 April, 2024</td>
                                    <td><img src="src/view/assets/images/users/avatar-6.jpg" alt="avatar-2"
                                            class="img-fluid avatar-xs rounded-circle"> <span
            ...
            <div class="col-xl-8">
                <div class="card">
                    ...
                    <div class="modal fade" id="CrearEvento" tabindex="-1"
                        aria-labelledby=CrearEventoLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <div id="alert-container_evento"></div>
                                        <form class="row g-3" id="frm_new_evento">
                                            <div class="col-md-12">
                                                <label for="titulo" class="form-label">Titulo</label>
                                                <input type="text" class="form-control" id="titulo" name="titulo" required placeholder="xxxxxxxxxx-xxxx-12">
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="categoria_id" name="categoria_id" required placeholder="xxxxxxxxxx-xxxx-12">
                                            </div>
                                            <div class="col-md-12">
                                                <label for="fecha_inicio" class="form-label">Fecha Inicio</label>
                                                <input type="date" class="form-control" id="fecha_inicio" name="fecha_inicio" required placeholder="xxxxxxxxxx-xxxx-12">
                                            </div>
                                            <div class="col-md-12">
                                                <label for="fecha_fin" class="form-label">Fecha fin</label>
                                                <input type="date" class="form-control" id="fecha_fin" name="fecha_fin" required placeholder="xxxxxxxxxx-xxxx-12">
                                            </div>
                                            <div class="col-md-12">
                                                <label for="ubicacion" class="form-label">Ubicación</label>
                                                <input type="text" class="form-control" id="ubicacion" name="ubicacion" required placeholder="xxxxxxxxxx-xxxx-12">
                                            </div>
                                            <div class="col-md-12">
                                                <label for="organizador_id" class="form-label">Organizador ID</label>
                                                <input type="text" class="form-control" id="organizador_id" name="organizador_id" required placeholder="xxxxxxxxxx-xxxx-12">
                                            </div>
                                            <div id="alert-container"></div>
                                            <div class="col-md-12">
                                                <button class="btn btn-primary col-12" type="button" onclick="CrearEvento();">Crear</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
