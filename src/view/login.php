...
<div class="glitch-form-wrapper">
  <form class="glitch-card" id="frm_login">
    ...
    <div class="card-body">
      <div class="form-group">
        <input
          ...
          placeholder=""
        />
        <label for="username" class="form-label" data-text="USERNAME" id="username" name="username"
          >USERNAME</label
        >
      </div>
      ...
      <div class="form-group">
        <input
          ...
          placeholder=""
        />
        <label for="password" class="form-label" data-text="ACCESS_KEY" id="password" name="password"
          >ACCESS_KEY</label
        >
      </div>
